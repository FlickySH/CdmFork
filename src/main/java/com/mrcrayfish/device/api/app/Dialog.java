...
public abstract class Dialog extends Wrappable
{
	...
	public static class Input extends Dialog
	{
		...
		public void init()
		{
			...
			buttonPositive.setClickListener((int mouseX, int mouseY, int mouseButton) ->
			{
			...
			buttonNegative.setClickListener((int mouseX, int mouseY, int mouseButton) -> close());
			this.addComponent(buttonNegative);
		}
	...
	public static class Print extends Dialog
	{
		...
		public void init()
		{
			...
			buttonRefresh.setClickListener((int mouseX, int mouseY, int mouseButton) ->
			{
				if(mouseButton == 0)
				{
			...
			buttonPrint.setClickListener((int mouseX, int mouseY, int mouseButton) ->
			{
				if(mouseButton == 0)
				{
			...
			buttonCancel.setClickListener((int mouseX, int mouseY, int mouseButton) ->
			{
				if(mouseButton == 0)
				{
					close();
			...
			buttonInfo.setClickListener((int mouseX, int mouseY, int mouseButton) ->
			{
				if(mouseButton == 0)
				{
					PrinterEntry printerEntry = itemListPrinters.getSelectedItem();
		...
		private static class Info extends Dialog
		{
			...
			public void init()
			{
				...
				buttonClose.setClickListener((int mouseX, int mouseY, int mouseButton) ->
				{
					if(mouseButton == 0)
					{
						close();
