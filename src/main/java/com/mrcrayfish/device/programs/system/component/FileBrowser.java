...
public class FileBrowser extends Component
{
    ...
    private static final Color APP_SCHEME = Color.decode("0xFBBA47");
    ...
    public void init(Layout layout)
    {
        ...
        btnNewFolder = new Button(5, 26, Icons.NEW_FOLDER);
        ...
        btnRename = new Button(26, 26, Icons.RENAME);
        ...
        if(mode == Mode.FULL)
        {
            ...
            btnCopy = new Button(47, 26, Icons.COPY);
            ...
            btnCut = new Button(68, 26, Icons.CUT);
            ...
            btnPaste = new Button(89, 26, Icons.CLIPBOARD);
        ...
        btnDelete = new Button(110, 26, Icons.TRASH);
        ...
        fileList = new ItemList<>(mode.getOffset(), 47, 180, mode.getVisibleItems());
        ...
        comboBoxDrive = new ComboBox.List<>(5, 47, 100, 100, new Drive[]{});
        ...
        labelPath = new Label("/", 131, 31);
        labelPath.setShadow(false);
        labelPath.setTextColour(Color.BLACK);
    ...
    private void updatePath()
    {
        ...
        path = path.replace("/", TextFormatting.BLACK + "/" + TextFormatting.RESET);
    ...
    public enum Mode
    {
        FULL(295, 148, 110, 5), BASIC(210, 120, 25, 4);
