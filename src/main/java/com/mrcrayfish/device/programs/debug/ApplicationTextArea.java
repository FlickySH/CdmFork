...
public class ApplicationTextArea extends Application
{
    ...
    public void init()
    {
        ...
        buttonWordWrap.setClickListener((int mouseX, int mouseY, int mouseButton) ->
        {
            if(mouseButton == 0)
            {
        ...
        buttonDebug.setClickListener((int mouseX, int mouseY, int mouseButton) ->
        {
            if(mouseButton == 0)
            {
        ...
        buttonHighlight.setClickListener((int mouseX, int mouseY, int mouseButton) ->
        {
            if(mouseButton == 0)
            {
