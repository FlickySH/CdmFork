...
public class ApplicationPixelPainter extends Application
{
	...
	public void init()
	{
		...
		btnLoadSavedPicture.setClickListener((int mouseX, int mouseY, int mouseButton) ->
		{
		...
		btnBrowseSavedPicture.setClickListener((int mouseX, int mouseY, int mouseButton) ->
		{
		...
		btnDeleteSavedPicture.setClickListener((int mouseX, int mouseY, int mouseButton) ->
		{
			if(listPictures.getSelectedIndex() != -1)
			{
		...
		btnBackSavedPicture.setClickListener((int mouseX, int mouseY, int mouseButton) -> setCurrentLayout(layoutMainMenu));
		...
		button.setClickListener((int mouseX, int mouseY, int mouseButton) ->
		{
			if(mouseButton == 0)
			{
